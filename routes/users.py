        ...
        if user_profile:
            ...
            if valid_image:
                ...
                if result:
                    ...
                    is_created:bool=User.create_user(session,username, email, password, phone_number,profile_image_url,id_,lalitude,longitude,role,FERNET_KEY)
                    if is_created:
            ...
            is_created:bool=User.create_user(session,username, email, password, phone_number,None,None,lalitude,longitude,role,FERNET_KEY)
        if not is_created:
            raise UserExistException(f"User already exist with this email {email} or you have a problem in connexion")
